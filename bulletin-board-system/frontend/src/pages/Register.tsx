...
const Register: React.FC = () => {
  ...
  const checkPasswordStrength = (password: string) => {
    ...
    if (score === 0) feedback = '非常に弱い'
    else if (score === 1) feedback = '弱い'
    else if (score === 2) feedback = '普通'
    else if (score === 3) feedback = '強い'
    else if (score === 4) feedback = '非常に強い'
    else feedback = '最強'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 登録成功後はAuthContextでログインとリダイレクトが行われる
    } catch (error) {
  ...
  const getPasswordStrengthColor = () => {
    ...
    if (passwordStrength.score <= 3) return 'text-blue-600'
          ...
          <CardBody>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <Input
                ...
                helpText="3-20文字の英数字とアンダースコアのみ使用可能"
                required
              />
